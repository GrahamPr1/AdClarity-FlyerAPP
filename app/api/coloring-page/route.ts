...
//
// Available on EVERY plan. It costs one campaign credit from the same monthly
// allowance as a flyer (the reserveFlyerQuota claim below) — the allowance is
// the limit, not the tier.

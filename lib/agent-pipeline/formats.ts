...
export function formatForAgent(id: FormatId | string | undefined) {
  ...
  return { id: f.id, label: f.label, dimensions: f.dimensions, medium: f.medium, brief: f.brief }
}
